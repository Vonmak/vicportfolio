      ...
      <div className="grid grid-cols-1 mt-10 gap-5 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="cursor-pointer flex flex-col gap-5 p-3 border border-slate-700  rounded  md:gap-3">
          ...
          <div className="space-y-3">
            ...
            <p className="text-[15px]">
              This project is mean't to help landlords manage their apartments
              and tenants make payment to the landlord easily.
            </p>
            <a
        ...
        <div className="cursor-pointer flex flex-col gap-5 p-3 border border-slate-700  rounded  md:gap-3">
          ...
          <div className="space-y-3">
            ...
            <p className="text-[15px]">
              ...
              everyone, everywhere. Our service is connect vendors with
              customers around the globe and enable vendors to reach more
              customers and biuld their business.
            </p>
            <a
