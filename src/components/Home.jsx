  ...
  return (
    <div className="flex flex-col justify-evenly mx-auto px-24 lg:h-screen">
      <div className="mt-20 border-dashed border-b border-cyan-900 pb-5 flex flex-col items-center md:pb-0 xl:pb-16 md:flex-row">
        <div className="space-y-1 mt-10 w-full md:space-y-10 md:mt-0 md:w-1/2 p-2">
        ...
        <div class="flex justify-center bg-cyan-900 h-[18rem] w-[18rem] rounded-full order-first md:w-1/3 md:order-none md:h-[16rem] lg:h-[19rem] xl:h-[24rem]">
          <img src={ve} alt="" class="h-full w-full  object-cover" />
        </div>
        <div className="flex flex-row w-full mt-3 justify-between md:flex-col md:mt-0 md:spcae-y-5 md:justify-end  md:items-end md:w-1/3">
          <div className="flex ">
      ...
      {/* <svg viewBox="0 0 1155 678" xmlns="http://www.w3.org/2000/svg">
              <path
